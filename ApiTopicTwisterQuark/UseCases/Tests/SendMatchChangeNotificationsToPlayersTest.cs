...
{
    public class SendMatchChangeNotificationsToPlayersTest
    {
        SendMatchChangeNotificationsToPlayers sendMatchChangeNotificationsToPlayers;
        ...
        public void SetUp()
        {
            ...
            sendMatchChangeNotificationsToPlayers =
                new SendMatchChangeNotificationsToPlayers(matchRepository, notificationService, allForGameNotificationsIDs);
        ...
        public async Task Execute_Should_Add_ForGameNotification_Foreach_Player()
        {
            ...
            {
                await notificationService.Received().AddPlayerForGameNotification(playerId, allForGameNotificationsIDs.matchesChange);
            }
        }
